...
![1539921699443](images/1539921699443.png)
...
**由于“客居”于操作系统，容器只能运行与底层宿主机相同或者相似的操作系统，这看起来并不是非常灵活。例如：可以在Ubuntu服务中运行RedhatEnterpriseLinux，但无法再Ubuntu服务器上运行MicrosoftWindows。**  传统的虚拟机是有种类的，docker则可以运行任何系统的集装箱（将软件与系统一起打包装到容器中)
...
![1539922226164](images/1539922226164.png)
...
![1577278469974](images/1577278469974.png)
...
```shell
docker run -di --name=pinyougou_tomcat -p 8080:8080 tomcat:7-jre8
```

### 5.2.3部署web应用

测试：地址栏输入：http://192.168.211.128:8080
...
![1539962195129](images/1539962195129.png)
